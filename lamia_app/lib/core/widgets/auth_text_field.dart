    ...
    return Column(
      ...
      children: [
        ...
        Semantics(
          label: widget.label,
          textField: true,
          // Animate the fill color between idle and focused states so focus
          // changes feel fluid instead of snapping.
          child: TweenAnimationBuilder<Color?>(
            tween: ColorTween(
              begin: AppColors.surfaceAlt,
              end: _focused ? AppColors.surface : AppColors.surfaceAlt,
            ),
